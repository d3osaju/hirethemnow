...
namespace HireThemNoW.Server.Migrations
{
    ...
    [Migration("20251020092503_AddColdMailGenerationHistory")]
    partial class AddColdMailGenerationHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HireThemNoW.Server.Models.ColdMailGenerationHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("ColdMailGenerationHistories", "public");
                });
            ...
            modelBuilder.Entity("HireThemNoW.Server.Models.ColdMailGenerationHistory", b =>
                {
                    b.HasOne("HireThemNoW.Server.Models.JobOpportunity", "JobOpportunity")
                        .WithMany()
                        .HasForeignKey("JobId")
